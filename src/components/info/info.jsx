            ...
            <div className="container">
                ...
                <div className="right">
                    ...
                    <div className="content-up">
                        <img src={four} />
                        <div className="txt">
                            <h3>اليوم.. طقس حار رطب نهارًا معتدل رطب ليلاً على كل الأنحاء</h3>
                            <p> منذ 9 ساعات</p>
                    ...
                    <div className="table table-two">
                        <div className="content-left">
                            <ul className="time-table">
                                <h2>أسعار العملات</h2>
                                <li>دولار أمريكي<p>18.88L.E</p></li>
                                <li>يورو <span>hiiiiiii</span><p>19.03L.E</p></li>
                                <li>جنيه إسترليني<p>22.38L.E</p></li>
                                <li>ريال سعودي<span>i</span><p>5.03L.E</p></li>
                                <li>درهم إماراتي<p>5.14L.E</p></li>
                                <li>دينار كويتي<p>61.29L.E</p></li>
                            </ul>
                        </div>
                    </div>
                </div>
